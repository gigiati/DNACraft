...
public class Body extends BodyPart {
	...
	public Body(ModelBase base, String texture, int textureOffsetX, int textureOffsetY,
			int width, int height, int depth, float rotPointX, float rotPointY,
			float rotPointZ) {
		super(base, texture, textureOffsetX, textureOffsetY, width, height, depth, rotPointX,
				rotPointY, rotPointZ);
	}
